...
function MotionProvider(_ref) {
  var children = _ref.children, props = _objectWithoutProperties(_ref, _excluded$2);
...
const ProviderChildren = (props) => {
  ...
  const memoTheme = reactExports.useMemo(() => {
    const _a = mergedTheme || {}, {
      ...
      components,
      cssVar
    } = _a, rest = __rest$1(_a, ["algorithm", "token", "components", "cssVar"]);
...
var validSettings = Object.keys(defaultProps);
...
var Track = /* @__PURE__ */ function(_React$PureComponent) {
  function Track2() {
    ...
    _this = _callSuper$4(this, Track2, [].concat(args));
...
var Dots = /* @__PURE__ */ function(_React$PureComponent) {
  function Dots2() {
    ...
    return _callSuper$3(this, Dots2, arguments);
  }
...
var PrevArrow = /* @__PURE__ */ function(_React$PureComponent) {
  function PrevArrow2() {
    ...
    return _callSuper$2(this, PrevArrow2, arguments);
  }
...
var NextArrow = /* @__PURE__ */ function(_React$PureComponent2) {
  function NextArrow2() {
    ...
    return _callSuper$2(this, NextArrow2, arguments);
  }
...
var InnerSlider = /* @__PURE__ */ function(_React$Component) {
  function InnerSlider2(props) {
    ...
    _this = _callSuper$1(this, InnerSlider2, [props]);
    ...
    _defineProperty(_this, "clickHandler", function(e2) {
    ...
    _defineProperty(_this, "keyHandler", function(e2) {
    ...
    _defineProperty(_this, "swipeStart", function(e2) {
    ...
    _defineProperty(_this, "swipeMove", function(e2) {
      var state = swipeMove(e2, _objectSpread2(_objectSpread2(_objectSpread2({}, _this.props), _this.state), {}, {
        trackRef: _this.track,
        listRef: _this.list,
    ...
    _defineProperty(_this, "swipeEnd", function(e2) {
      var state = swipeEnd(e2, _objectSpread2(_objectSpread2(_objectSpread2({}, _this.props), _this.state), {}, {
        trackRef: _this.track,
        listRef: _this.list,
        slideIndex: _this.state.currentSlide
      }));
    ...
    _defineProperty(_this, "touchEnd", function(e2) {
      _this.swipeEnd(e2);
      _this.clickable = true;
    });
...
var Slider = /* @__PURE__ */ function(_React$Component) {
  function Slider2(props) {
    ...
    _this = _callSuper(this, Slider2, [props]);
...
const useStyle = genStyleHooks("Carousel", (token2) => [genCarouselStyle(token2), genArrowsStyle(token2), genDotsStyle(token2), genCarouselVerticalStyle(token2), genCarouselRtlStyle(token2)], prepareComponentToken, {
...
const Carousel = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  const {
    dots = true,
    arrows = false,
    prevArrow = /* @__PURE__ */ reactExports.createElement(ArrowButton, {
      "aria-label": "prev"
    }),
    nextArrow = /* @__PURE__ */ reactExports.createElement(ArrowButton, {
      "aria-label": "next"
    }),
    draggable = false,
    ...
    style: style2,
    id: id2
  } = props, otherProps = __rest(props, ["dots", "arrows", "prevArrow", "nextArrow", "draggable", "waitForAnimate", "dotPosition", "vertical", "rootClassName", "className", "style", "id"]);
  const {
    getPrefixCls,
    direction,
    carousel
  } = reactExports.useContext(ConfigContext);
  const slickRef = reactExports.useRef();
  ...
  const prevCount = reactExports.useRef(reactExports.Children.count(props.children));
  reactExports.useEffect(() => {
    if (prevCount.current !== reactExports.Children.count(props.children)) {
      goTo(props.initialSlide || 0, false);
      prevCount.current = reactExports.Children.count(props.children);
    }
  }, [props.children]);
  ...
  return wrapCSSVar(/* @__PURE__ */ reactExports.createElement("div", {
    className,
    id: id2
  }, /* @__PURE__ */ reactExports.createElement(Slider, Object.assign({
    ref: slickRef
  }, newProps, {
    dots: enableDots,
    dotsClass: dsClass,
...
function Layout({ settings, layoutType, imageUrl, title, subtitle, description, socialIcons }) {
  ...
  reactExports.useEffect(() => {
    if (layoutType) {
      __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./Avatar/Frontend.jsx": () => __vitePreload(() => Promise.resolve().then(() => Frontend), true ? void 0 : void 0), "./Blur/Frontend.jsx": () => __vitePreload(() => import("./Frontend-CJefyZy5.js"), true ? [] : void 0), "./Card/Frontend.jsx": () => __vitePreload(() => import("./Frontend-BFxNbjLa.js"), true ? [] : void 0) }), `./${layoutType}/Frontend.jsx`, 3).then((module) => {
