...
function Layout({ layoutType, imageUrl, title, subtitle, description, socialIcons }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${container.style} ${animation.style}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: content.style, children: [
