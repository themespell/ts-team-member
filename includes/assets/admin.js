...
function App() {
  const [selectedAnimation, setSelectedAnimation] = reactExports.useState("tsh-3d-float");
  const handleSelectChange = (event) => {
    setSelectedAnimation(event.target.value);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-center text-3xl font-bold mb-8", children: "Team Design 01" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { onChange: handleSelectChange, className: "p-2 border rounded", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tsh-3d-float", children: "3D Float" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tsh-tilt", children: "Tilt" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tsh-slide-top", children: "Slide Top" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tsh-shadow-pop-tr", children: "Shadow Pop" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tsh-shadow-drop-center", children: "Drop Shadow" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "tsh-shadow-drop-2-tr", children: "Drop Shadow 2" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: selectedAnimation, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${selectedAnimation}__wrapper max-w-sm bg-white rounded-lg shadow-lg overflow-hidden`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "w-full h-auto rounded-lg", src: "https://www.fionabruce.co.uk/wp-content/uploads/2024/01/phil-porter.png.webp", alt: "Phil Porter" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-gray-900", children: "Philip Porter" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-gray-600", children: "Managing Partner, Head of Family & Matrimonial Law" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "inline-block bg-orange-200 text-orange-800 text-xs font-semibold px-2 py-1 rounded-full", href: "/specialised-in/family-law", target: "_blank", children: "Family Law" }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: selectedAnimation, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${selectedAnimation}__wrapper max-w-sm bg-white rounded-lg shadow-lg overflow-hidden`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "w-full h-auto rounded-lg", src: "https://www.fionabruce.co.uk/wp-content/uploads/2024/01/phil-porter.png.webp", alt: "Phil Porter" }) }),
...
function buildHTMLStyles(state2, latestValues, transformTemplate2) {
  ...
  if (!latestValues.transform) {
    if (hasTransform2 || transformTemplate2) {
      style.transform = buildTransform(state2.transform, transformIsNone, transformTemplate2);
...
function makeLatestValues(props, context, presenceContext, shouldApplyWillChange, scrapeMotionValues) {
  ...
  const values = {};
  const willChange = [];
  const applyWillChange = shouldApplyWillChange && ((_a4 = props.style) === null || _a4 === void 0 ? void 0 : _a4.willChange) === void 0;
...
const animateMotionValue = (name, value, target, transition2 = {}, element, isHandoff, onEnd) => (onComplete) => {
...
function addValueToWillChange(visualElement, key) {
  ...
  if (!willChange && !((_a4 = visualElement.props.style) === null || _a4 === void 0 ? void 0 : _a4.willChange)) {
...
class AnimationFeature extends Feature {
  ...
  unmount() {
    ...
    (_a4 = this.unmountControls) === null || _a4 === void 0 ? void 0 : _a4.call(this);
  }
}
let id$1 = 0;
...
class VisualElementDragControls {
  ...
  start(originEvent, { snapToCursor = false } = {}) {
    ...
    const onStart = (event, info) => {
      ...
      (_a4 = this.removeWillChange) === null || _a4 === void 0 ? void 0 : _a4.call(this);
...
function createProjectionNode({ attachResizeListener, defaultParent, measureScroll, checkIsScrollRoot, resetTransform }) {
  return class ProjectionNode {
    ...
    measurePageBox() {
      ...
      const wasInScrollRoot = ((_a4 = this.scroll) === null || _a4 === void 0 ? void 0 : _a4.wasRoot) || this.path.some(checkNodeWasScrollRoot);
      if (!wasInScrollRoot) {
    ...
    removeElementScroll(box) {
      ...
      if ((_a4 = this.scroll) === null || _a4 === void 0 ? void 0 : _a4.wasRoot) {
    ...
    resolveTargetDelta(forceRecalculation = false) {
      ...
      const canSkip = !(forceRecalculation || isShared && this.isSharedProjectionDirty || this.isProjectionDirty || ((_a4 = this.parent) === null || _a4 === void 0 ? void 0 : _a4.isProjectionDirty) || this.attemptToResolveRelativeTarget || this.root.updateBlockedByResize);
      if (canSkip)
        return;
    ...
    scheduleRender(notifyAll = true) {
      var _a4;
      (_a4 = this.options.visualElement) === null || _a4 === void 0 ? void 0 : _a4.scheduleRender();
      if (notifyAll) {
        const stack = this.getStack();
